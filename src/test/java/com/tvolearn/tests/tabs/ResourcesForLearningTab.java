...
public class ResourcesForLearningTab {
    private static final Logger logger = LogManager.getLogger(ResourcesForLearningTab.class);
    ...
    public ResourcesForLearningTab(WebDriver driver, WebDriverWait wait, ExtentTest extentTest) {
        this.driver = driver;
        this.wait = wait;
    ...
    public void navigateAndValidate() {
        validateTabNavigation("Resources for Learning", "https://tvolearn.com/pages/grade-2-mathematics");
    ...
    private void validateTabNavigation(String tabText, String expectedUrl) {
        ...
        try {
            ...
            logger.info("Navigated to Resources for Learning Content");
            extentTest.info("Navigated to Resources for Learning Content");
        } catch (Exception e) {
