...
public class VocabularyTab {
    private static final Logger logger = LogManager.getLogger(VocabularyTab.class);
    ...
    public VocabularyTab(WebDriver driver, WebDriverWait wait, ExtentTest extentTest) {
        this.driver = driver;
        this.wait = wait;
    ...
    public void navigateAndValidate() {
        validateTabNavigation("Vocabulary", "https://tvolearn.com/pages/grade-2-mathematics");
    ...
    private void validateTabNavigation(String tabText, String expectedUrl) {
        ...
        try {
            ...
            logger.info("Navigated to Vocabulary Content");
            extentTest.info("Navigated to Vocabulary Content");
        } catch (Exception e) {
